@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="bg-medium text-dark flex items-center justify-between rounded">
        <div class="flex justify-between flex-1">
            ...
            @endif
{{--              <div class="max-[1600px]:hidden ml-80 md:max-2xl:pl-10">--}}
...
{{--              </div>--}}
              ...
              <div class=" sm:flex-2 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p class="text-sm text-dark leading-5 font-bold font px-40 min-[600px]:max-[800px]:px-10 max-[600px]:px-0 max-[800px]:py-4">
                    {!! __('Showing') !!}
